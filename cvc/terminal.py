...
class Type:
    ...
    def to_bytes(self):
        ...
        x |= self.__chat
        return to_bytes(x, (total + 7) // 8, 'big')
...
class TypeIS(Type):
    ...
    def __init__(self, role, **kwargs):
        super(TypeIS, self).__init__(role, self._args, kwargs)
...
class TypeAT(Type):
    ...
    def __init__(self, role, **kwargs):
        super(TypeAT, self).__init__(role, self._args, kwargs)
...
class TypeST(Type):
    ...
    def __init__(self, role, **kwargs):
        super(TypeST, self).__init__(role, self._args, kwargs)
